...
public class ControllerAdminHome {
	...
	*/
	...
	protected static void performInvitation () {
		...
		String verifiedEmail = EmailAddressRecognizer.checkEmailAddress(emailAddress);
			/*
		if (invalidEmailAddress(emailAddress)) {
			return;
		}
			*/
		if(verifiedEmail.compareTo("") != 0) {
			ViewAdminHome.alertEmailError.setContentText(verifiedEmail);
			ViewAdminHome.alertEmailError.setHeaderText("Email is invalid.");
