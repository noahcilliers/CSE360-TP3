	...
	*/
	...
	protected static void doLogin(Stage ts) {
    	...
    	if(verifiedPassword.compareTo("") != 0) {
    		ViewUserLogin.alertUsernamePasswordError.setContentText(verifiedPassword);
    		ViewUserLogin.alertUsernamePasswordError.showAndWait();
    		ViewUserLogin.alertUsernamePasswordError.setContentText("");
    	}
    	else if(verifiedUsername.compareTo("") != 0) {
    		ViewUserLogin.alertUsernamePasswordError.setContentText(verifiedUsername);
    		ViewUserLogin.alertUsernamePasswordError.showAndWait();
    		ViewUserLogin.alertUsernamePasswordError.setContentText("");
    	};
    	...
    	System.out.println("onetimepass: " + oneTimePassword);
