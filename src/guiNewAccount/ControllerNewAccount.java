...
public class ControllerNewAccount {
	...
	*/
	...
	protected static void doCreateUser() {
    	...
    	String verifiedPassword = PasswordRecognizer.checkForValidPassword(password);
    	String verifiedUsername = UserNameRecognizer.checkForValidUserName(username);
    	
    	if(verifiedPassword.compareTo("") != 0) {
    		ViewNewAccount.alertUsernamePasswordError.setContentText(verifiedPassword);
    		ViewNewAccount.alertUsernamePasswordError.setHeaderText("Password is invalid.");
    		ViewNewAccount.alertUsernamePasswordError.showAndWait();
    		ViewNewAccount.alertUsernamePasswordError.setContentText("");
    		return;
    	}
    	else if(verifiedUsername.compareTo("") != 0) {
    		ViewNewAccount.alertUsernamePasswordError.setContentText(verifiedUsername);
    		ViewNewAccount.alertUsernamePasswordError.setHeaderText("Username is invalid.");
    		ViewNewAccount.alertUsernamePasswordError.showAndWait();
    		ViewNewAccount.alertUsernamePasswordError.setContentText("");
    		return;
    	};
