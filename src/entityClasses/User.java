...
public class User {
     ...
     * 
     * @param fn specifies the the Admin attribute (TRUE or FALSE) for this user
     * 
     * @param mn specifies the the Student attribute (TRUE or FALSE) for this user
     * 
     * @param ln specifies the the Reviewer attribute (TRUE or FALSE) for this user
     * 
     * @param pfn specifies the perferred first name
     * 
     * @param ea specifies the email address
     * 
     * @param r1 specifies the admin role
     * 
     * @param r2 specifies the student role 
     * 
     * @param r3 specifies the staff role 
     * 
     */
